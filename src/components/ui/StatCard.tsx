  ...
  return (
    <Card className={className}>
      <CardContent className="flex items-center p-4 md:p-5">
        <div className="w-12 h-12 rounded-full bg-brand-100 text-brand-600 flex items-center justify-center mr-4 shrink-0">
          {icon}
        </div>
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-baseline gap-2">
            ...
            {trend && (
              <span className={`text-xs font-bold ${trend.isPositive ? 'text-brand-600' : 'text-rose-600'}`}>
