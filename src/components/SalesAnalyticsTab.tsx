...
export default function SalesAnalyticsTab({ lang, salesLogs = [] }: SalesAnalyticsTabProps) {
 ...
 <span className="text-3xl font-black text-emerald-950 font-mono block">
 {(Number(totalRevenue) || 0).toLocaleString()} <span className="text-sm text-emerald-600">SYP</span>
 </span>
 </div>
 <div className="p-4 bg-white border border-emerald-100 rounded-xl shadow-sm">
 <div className="flex items-center gap-2 mb-2">
 ...
 {(Number(totalProfit) || 0).toLocaleString()} <span className="text-sm text-emerald-600">SYP</span>
 </span>
 </div>
 </div>

 <div className="bg-white border border-emerald-100 rounded-xl shadow-sm overflow-hidden">
 <div className="p-4 border-b border-emerald-100 bg-slate-50/50 flex items-center gap-2">
 ...
 <span className="font-extrabold text-emerald-900 font-mono text-sm bg-emerald-50 px-2 py-0.5 rounded">
 ...
 <span className="font-black text-emerald-900 font-mono text-sm">{(Number(sale.totalRevenue) || 0).toLocaleString()} <span className="text-[10px] text-emerald-600">SYP</span></span>
 </div>
 ...
 <span className="font-black text-indigo-700 font-mono text-sm">{(Number(sale.totalProfit) || 0).toLocaleString()} <span className="text-[10px] text-emerald-600">SYP</span></span>
 </div>
 </div>
 </div>
 ))}
